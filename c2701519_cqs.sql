...
--
-- Servidor: localhost
-- Tiempo de generación: 25-01-2026 a las 01:00:04
...
INSERT INTO `citas` (`id`, `cliente_id`, `servicio_id`, `fecha`, `hora`, `estado`, `creado_en`) VALUES
(31, 17, 31, '2025-11-21 00:00:00', '09:30:00', 'confirmada', '2025-11-16 02:04:44'),
(32, 17, 30, '2025-11-21 00:00:00', '09:30:00', 'confirmada', '2025-11-16 02:08:59'),
(33, 18, 30, '2025-11-21 00:00:00', '10:00:00', 'confirmada', '2025-11-16 02:19:18'),
(34, 17, 30, '2025-11-21 00:00:00', '11:00:00', 'pendiente', '2025-11-16 02:23:06');
...
INSERT INTO `servicios` (`id`, `categoria_id`, `nombre`, `descripcion`, `imagen_url`, `precio`, `activo`, `orden`) VALUES
(30, 10, 'Limpieza Facial Deluxe', 'Evaluación, diagnóstico, análisis microscópico, higienización de la piel, microdermoabrasión, peeling, exfoliación, vapor ozono, extracción de impurezas, alta frecuencia, radiofrecuencia, mascarilla premium, dermapen, fototerapia LED, drenaje linfático, tonificación, ultrasonido, hidratación profunda, protección solar, rutina diaria.\n\n', 'https://res.cloudinary.com/dsbqbjfp4/image/upload/v1763000474/deluxe_w6y0ir.png', 28000.00, 1, 0),
(31, 10, 'Limpieza Facial Dermaplaning', 'Evaluación, diagnóstico, análisis microscópico, higienización de la piel, microdermoabrasión, peeling, dermaplaning, vapor ozono, extracción de impurezas, alta frecuencia, radiofrecuencia, mascarilla premium, fototerapia LED, drenaje linfático, tonificación, ultrasonido, hidratación profunda, protección solar, rutina diaria.', 'https://res.cloudinary.com/dsbqbjfp4/image/upload/v1763000473/dermaplaning_xxs047.png', 33000.00, 1, 0),
(32, 10, 'Limpieza Facial Premium', 'Evaluación, diagnóstico, análisis microscópico, higienización de la piel, microdermoabrasión, peeling, exfoliación, vapor ozono, extracción de impurezas, alta frecuencia, mascarilla, fototerapia LED, tonificación, hidratación profunda, protección solar, rutina diaria.', 'https://res.cloudinary.com/dsbqbjfp4/image/upload/v1763000474/premium_lmthie.png', 23000.00, 1, 0),
(33, 10, 'Limpieza Facial Pro', 'Evaluación, diagnóstico, análisis microscópico, higienización de la piel, microdermoabrasión, peeling, exfoliación, vapor ozono, extracción de impurezas, alta frecuencia, radiofrecuencia, masaje muscular, mascarilla premium, dermapen, fototerapia LED, drenaje linfático, tonificación, ultrasonido, hidratación profunda, protección solar, rutina diaria.', 'https://res.cloudinary.com/dsbqbjfp4/image/upload/v1763000474/pro_u01osa.png', 32000.00, 1, 0),
(34, 10, 'Limpieza Facial Gym', 'Evaluación, diagnóstico, análisis microscópico, higienización de la piel, microdermoabrasión, peeling, exfoliación, vapor ozono, extracción de impurezas, alta frecuencia, radiofrecuencia, masaje muscular por 25 minutos, mascarilla premium, fototerapia LED, drenaje linfático, tonificación, ultrasonido, hidratación profunda, protección solar, rutina diaria.', 'https://res.cloudinary.com/dsbqbjfp4/image/upload/v1763000472/gym_uertht.png', 28000.00, 1, 0),
(35, 10, 'Microneedling', 'Evaluación, diagnóstico, análisis microscópico, higienización de la piel, microdermoabrasión, peeling, exfoliación, desinfectante, anestesia tópica, dermapen con mesoterapia, ultrasonido, mascarilla descongestiva, fototerapia LED, loción descongestiva, rutina diaria.', 'https://res.cloudinary.com/dsbqbjfp4/image/upload/v1763000473/microneedling_ht7c6l.png', 40000.00, 1, 0),
(37, 10, 'Facial Químico', 'Evaluación, diagnóstico, análisis microscópico, higienización de la piel, microdermoabrasión, peeling enzimático, peeling químico (sin descamación), extracción de impurezas, alta frecuencia, radiofrecuencia, mascarilla premium, fototerapia LED, drenaje linfático, tonificación, ultrasonido, hidratación profunda, protección solar, rutina diaria.', 'https://res.cloudinary.com/dsbqbjfp4/image/upload/v1763000476/quimico_wamxqp.png', 37000.00, 1, 0);
...
INSERT INTO `usuarios_admin` (`id`, `username`, `email`, `password_hash`, `rol`, `creado_en`) VALUES
(2, 'Pedro', NULL, '$2y$10$hJWyrPoDzVpoXzok5mj6lOMChthPuyVv9xkMxuvsqIezIwtRLcREa', 'superadmin', '2025-11-06 23:22:24');
...
--
ALTER TABLE `password_resets`
  ADD CONSTRAINT `password_resets_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `usuarios_admin` (`id`) ON DELETE CASCADE;
